						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="{{ url('/dashboard')}}"><i class="bx bx-slider-alt"></i>لوحة التحكم</a>

									<form action="{{ route('logout')}}" method="POST">
										@csrf
										<button type="submit" class="dropdown-item" href="{{ route('logout') }}"><i class="bx bx-log-out"></i>تسجيل خروج</button>
									</form>								
